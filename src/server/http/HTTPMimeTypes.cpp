...
const std::map<std::string,std::string> MimeTypes::types = utils::CreateMap<std::string,std::string>
	("html","text/html")
	("htm","text/html")
	("shtml","text/html")
	("css","text/css")
...
std::string	MimeTypes::getMimeType(const std::string &ext) {
	...
	std::map<std::string,std::string>::const_iterator it = MimeTypes::types.find(ext);
